...
(function ($) {
    $.fn.loading = function () {
        ...
        $(this).each(function () {
            ...
            $target
                .find(".background")
                .css("background-color", opts.backgroundColor);
            ...
            (this.settings.mouseDrag
                ...
                this.settings.responsive !== !1 &&
                    this.on(
                        b,
                        "resize",
                        a.proxy(this.onThrottledResize, this),
                    ));
        }),
            ...
            if (this.settings.loop) {
                ...
                (h < this.settings.items && i === !1
                    ...
                    (this.e._goToLoop = b.setTimeout(
                        a.proxy(function () {
                            (this.speed(
                                this.duration(this.current(), f + e, d),
                            ),
                                this.current(f + e),
                                this.update());
                        }, this),
                    ...
                    ? (jQuery.mbYTPlayer.checkForStart(YTPlayer),
                      void (YTPlayer.getState = setInterval(function () {
                          ...
                          if (
                              ...
                              1 == YTPlayer.player.getPlayerState() &&
                                  (parseFloat(
                                      YTPlayer.player.getDuration() - 1.5,
...
((jQuery.browser.android = /Android/i.test(nAgt)),
    ...
    (jQuery.isAndroidDefault =
        jQuery.browser.android && !/chrome/i.test(nAgt)));
var nAgt = navigator.userAgent;
if (!jQuery.browser) {
    ((jQuery.browser = {}),
        (jQuery.browser.mozilla = !1),
